...
with col2:
    st.markdown(
        "<div style='text-align:right;width:100%;margin-top:10px;'><p style='font-size:15px; font-weight:normal; color:#aaaaaa; '>by <b style='font-size:16px;color:#0099FF'>CheokCeock</b><b style='font-size:22px;color:#009999'>1</b> <b style='font-size:14px;'>prototype v.01</b></p></div>",
        unsafe_allow_html=True
    )
