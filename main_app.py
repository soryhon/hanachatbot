...
st.sidebar.markdown(
    """
    <div style='text-align:center;width:100%;background-color:#F7F8FB;'><b style='font-size:22px;color:#000000'>📝CheokCeock</b><b style='font-size:30px;color:#009999'>1</b></div>
    """,
    unsafe_allow_html=True
)

st.sidebar.markdown(
    "<p style='background-color:#E7EAF1;border-radius: 5px;font-size:16px; font-weight:bold; color:#090909;text-align:center;width:100%;padding:8px;border:0px solid #cccccc;margin-top:15px;'>보고서 유형 선택</p>",
    unsafe_allow_html=True
)
