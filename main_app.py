...
st.sidebar.markdown(
    "<p style='background-color:#E7EAF1;border-radius: 5px;font-size:16px; font-weight:bold; color:#090909;text-align:center;width:100%;padding:8px;border:0px solid #cccccc;margin-top:15px;'>보고서 자동 완성</p>",
    unsafe_allow_html=True
)
