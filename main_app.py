...
st.sidebar.markdown(
    "<br/><p style='background-color:#DAE9F8;border-radius: 5px;font-size:18px; font-weight:bold; color:#090909;text-align:center;width:100%;padding:8px;border:0px solid #cccccc;'>보고서 자동 완성</p>",
    unsafe_allow_html=True
)
...
st.sidebar.markdown(
    """
    <div style='font-size:12px; font-weight:bold; color:#007BFF;text-align:center;width:100%;border-top:1px solid #cccccc;margin-left:15px;margin-right:15px;'></div>
    """,
    unsafe_allow_html=True
)
