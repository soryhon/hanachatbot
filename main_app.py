...
st.sidebar.markdown(
    """
    <div style='background-color:#E7EAF1;text-align:center;width:100%;padding-bottom:10px;border-radius:5px;'><b style='font-size:22px;color:#0099FF;font-style:italic;'>📝CheokCeock</b><b style='font-size:30px;color:#009999'>1</b></div>
    """,
